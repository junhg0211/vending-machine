...
S: 0 OK
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.5\textwidth]{images/snapshot/vending-machine.png}
        \caption{자판기의 실행 화면}
    ...
    \begin{figure}[h]
        ...
        \begin{minipage}{.5\textwidth}
            \includegraphics[width=\textwidth]{images/snapshot/not-enough.png}
            \caption{잔고 부족 오류 메시지}
            \label{fig:not-enough}
        \end{minipage}%
        \begin{minipage}{.5\textwidth}
            \includegraphics[width=\textwidth]{images/snapshot/bought-coffee.png}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.5\textwidth]{images/snapshot/cash-input.png}
        \caption{현금 투입 화면}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.5\textwidth]{images/snapshot/change.png}
        \caption{거스름 돈 반환 화면}
        \label{fig:change}
    \end{figure}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.5\textwidth]{images/snapshot/password.png}
    ...
    \begin{figure}[h]
        ...
        \begin{minipage}{0.5\textwidth}
            \includegraphics[width=0.5\textwidth]{images/snapshot/password-set-0}
            \caption{관리자 콘솔 비밀번호 설정 화면}
            \label{fig:password-set-0}
        \end{minipage}
        \begin{minipage}{0.5\tetxtwidth}
            \includegraphics[width=0.5\textwidth]{images/snapshot/password-set-1}
            \caption{관리자 콘솔 비밀번호 설정 화면}
    ...
    상품 이하의 탭은 \figref{fig:admin-inventory}\와 같이 구성되어 있다.
