...
S: 0 OK
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[height=0.5\textheight]{class-tree}
        \caption{자판기의 패키지 구조}
        \label{fig:uml}
    \end{figure}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.5\textwidth]{0316-password-dialog}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.5\textwidth]{0320-password-not-set}
    ...
    \begin{figure}[h]
        ...
        \begin{minipage}{.5\textwidth}
            \includegraphics[width=\textwidth]{0320-password-dialog-1}
            \caption{3월 20일에 구현한 비밀번호 다이얼로그 조건 불만족}
            \label{fig:0320-password-dialog-1}
        \end{minipage}%
        \begin{minipage}{.5\textwidth}
            \includegraphics[width=\textwidth]{0320-password-dialog-2}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.5\textwidth]{0321-admin-console}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.5\textwidth]{0405-password-change}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.5\textwidth]{0405-cash-take}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.8\textwidth]{0427-log-console}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.8\textwidth]{0524-daily-log}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=\textwidth]{0529-client}
